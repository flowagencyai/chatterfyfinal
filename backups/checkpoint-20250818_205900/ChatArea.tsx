...
export default function ChatArea() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      console.log('🔵 [DEBUG] Chamando addMessage para user:', userMessageObj);
      ...
      if (shouldUseAnonymous) {
        ...
        endpoint = `${API_BASE}/v1/chat/anonymous`;
      ...
      if (response.headers.get('content-type')?.includes('text/event-stream')) {
        ...
        console.log('🔵 [DEBUG] Processando resposta não-streaming...');
        ...
        console.log('🔵 [DEBUG] Chamando addMessage para assistant:', assistantMessageObj);
        
        addMessage(assistantMessageObj);
        console.log('🔵 [DEBUG] addMessage assistant chamado com sucesso');
      }
    } catch (error) {
